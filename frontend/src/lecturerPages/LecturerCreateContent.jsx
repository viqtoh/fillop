...
const LecturerCreateContent = () => {
  ...
  const handleLearningPathSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/lecturer/learningpath`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      navigate(`/lecturer/content-library/path/${result.learningPath.id}`);
    } catch (error) {
  ...
  const handleCourseSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/lecturer/course`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json"
      ...
      navigate(`/lecturer/content-library/course/${result.course.id}`);
    } catch (error) {
      showToast("Internal Server Error", false);
    }
  };
  ...
  return (
    <div>
      <div className="navHeader">
        <LecturerNavBar title="Content Management" subTitle="create" />
      </div>
...
export default LecturerCreateContent;
